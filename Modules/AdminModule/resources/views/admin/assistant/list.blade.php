...
@section('page_title', 'Admin assistants list')
                ...
                <div class="row">
                    <div class="col-md-9">
                        <div class="card-header border-bottom-0">
                            <form action="{{ route('admin.assistants.index') }}" method="get">
                    ...
                    <div class="col-md-3">
                        <div class="card-header border-bottom-0 float-end">
                            <a href="{{ route('admin.assistants.create') }}" class="btn btn-primary mb-4">Add new <i
                ...
                <div class="e-table px-5 pb-5">
                    <div class="table-responsive table-lg">
                        <table class="table border-top table-bordered mb-0">
                            ...
                            <tbody>
                                @include('adminmodule::admin.assistant.partials._table-rows', [
                                    'items' => $assistants,
                                ])
                            </tbody>
                        </table>
