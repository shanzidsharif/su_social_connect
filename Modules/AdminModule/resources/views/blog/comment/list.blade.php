...
@section('page_title', 'Admin blog comments')
    ...
    <div class="row row-cards">
        <div class="col-lg-12 col-xl-12">
            <div class="card">
                <div class="row">
                    <div class="col-md-12">
                        <form action="{{ route('admin.blogs.comment.store', $blog_id) }}" method="post">
                            @csrf
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center align-middle">
                                            <div class="g-2">
                                                ...
                                                <form action="{{ route('admin.blogs.comment.destroy', $item['id']) }}"
