...
@section('content')
    <section class="section">
        <div class="container">
            <h1 class="h1 text-center mb-5">Teacher registration</h1>
            <form method="POST" action="{{ route('teacher.auth.registration') }}" name="registration-form"
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-6 mb-4">
                        <input type="text" class="form-control" placeholder="Teacher id" name="teacher_id"
            ...
            $(function() {
                $("form[name='registration-form']").validate({
                    ...
                    messages: {
                        ...
                        teacher_id: "Please enter your student id",
